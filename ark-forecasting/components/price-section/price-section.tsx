...
import { PRICING_PLANS, type PricingAction } from "@/components/price-section/price-data";
...
export const PriceSection = ({ handleContactSales, handleSignUp }: PriceSectionProps) => {
  const handlePrimaryAction = (action: PricingAction) => {
    if (action === "sales") {
      handleContactSales();
      return;
    }
